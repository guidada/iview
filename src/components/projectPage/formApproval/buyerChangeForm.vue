...
<script>
  import myCreate from './buyerChangeForm/myCreate'
  import myShenPi from './buyerChangeForm/myShenPi'
  import myChaoSong from './buyerChangeForm/myChaoSong'
  import addFavorable from './buyerChangeForm/addFavorable'
  ...
  export default {
    ...
    created() {
      ...
      this.shenPiCount = this.getUserInfo.people_shenhe_count
      this.chaoSongCount = this.getUserInfo.people_chaosong_count
      this.getShenPiCount()
    },
    methods: {
      /*
     ...
     * */
      ...
      * */
      changeTap(res) {
        ...
        if (res === '审批') {
          ...
          this.$post('/chaosong/clear', {type: 'people'}).then(res => {
      ...
      * */
      ...
      getShenPiCount() {
        this.$post('/shenhe/count', {type: 'people'}).then(res => {
