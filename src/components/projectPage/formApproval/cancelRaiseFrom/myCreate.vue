<template>
  <Card v-if="isViewCancelRaise">
    <viewCancelraise
      ...
      :viewInfo="viewInfo"
      :isEditCancelRaise="isEditCancelRaise"
    ></viewCancelraise>
  </Card>
  <div v-else class="my_create_container">
    ...
    <!-- 新建按钮-->
    <div class="btn_wrap">
      <Button type="primary" @click="gotoAddCancelRaise">新建表单</Button>
    </div>
    <!-- 解筹列表-->
  ...
  export default {
     ...
     * */
      ...
      * */
      ...
      gotoAddCancelRaise() {
        var flag = true
        this.$emit('gotoAddCancelRaise', flag)
      },
      /*
      *  页面切换的处理
      * */
