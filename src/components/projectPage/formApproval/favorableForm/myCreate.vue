<template>
  <Card v-if="isViewFavorable">
    <viewFavorable
      ...
      :viewInfo="viewInfo"
      :isEditFavorable="isEditFavorable"
    ></viewFavorable>
  </Card>
  <div v-else class="my_create_container">
    ...
    <!-- 新建按钮-->
    <div class="btn_wrap">
      <Button type="primary" @click="gotoAddFavorable">新建表单</Button>
    </div>
    <!-- 优惠单列表-->
  ...
  export default {
     ...
     * */
      ...
      * */
      ...
      gotoAddFavorable() {
        var flag = true
        this.$emit('gotoAddFavorable', flag)
      },
      /*
      *  页面切换的处理
      * */
