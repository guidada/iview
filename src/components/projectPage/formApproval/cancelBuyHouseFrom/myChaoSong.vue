<template>
  ...
  <div v-else class="my_chao_song_container">
    <!-- 筛选-->
      ...
      * */
      getCancelBuyHouseListByTap(tap, page) {
        this.$post('/unqianyue/lists', {
          ...
          if (res.status_code !== 200) return this.$Message.error('获取退房清单列表失败！')
