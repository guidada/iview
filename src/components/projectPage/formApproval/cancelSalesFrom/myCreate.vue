<template>
  <Card v-if="isViewCancelSales">
    <viewCancelSales
      ...
      :isEditCancelSales="isEditCancelSales"
    ></viewCancelSales>
  </Card>
  <div v-else class="my_create_container">
    ...
    <!-- 新建按钮-->
    <div class="btn_wrap">
      <Button type="primary" @click="gotoAddCancelSales">新建表单</Button>
    </div>
    <!-- 销控列表-->
  ...
  export default {
     ...
     * */
      ...
      * */
      ...
      gotoAddCancelSales() {
        var flag = true
        this.$emit('gotoAddCancelSales', flag)
      },
      /*
      *  页面切换的处理
      * */
