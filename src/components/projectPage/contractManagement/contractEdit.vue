  ...
  <div class="project-container">
    <Form :label-width="200">
        <FormItem label="关联房源：">
          <Row>
            <Col :span="6">
              <Cascader :placeholder="holdhouse" :data="buildingData" :load-data="loadData" v-model="building"></Cascader>
            </Col>
          </Row>
        </FormItem>
  ...
  export default {
    ...
    methods: {
      ...
      save() {
        ...
        this.$post('/contract/updateContract', {
    ...
    created() {
      this.getBuilding()
      this.$route.params.img.forEach((item,index) => {
      ...
      this.building = [this.$route.params.house.building_id,this.$route.params.house.unit_id,this.$route.params.house.room]
    }
  }
</script>
